...
<div className="d-flex justify-content-between align-items-center">
    <input onChange={e=>setAmount(e.target.value)} type="text" placeholder='enter amount to be increement' className="form-control" />
    <button onClick={handleIncrementAmount} className="btn btn-primary">Increement by amount</button>
